const data = {
    ...
    },
    {
        ...
        questions: [
            ...
            { id: 'odg_preambule_q17', type: 'QCM', question: '"constamment", "sans cesse", "à chaque instant" sont des ?', options: ["Groupes nominaux", "Compléments circonstanciels de temps", "Compléments circonstanciels de lieu", "Verbes pronominaux"], answer: [1], explanation: 'Se seont des Compléments circonstantiels de temps. Comme l\'anaphore "afin que" ils ont une dimension argumentative et ils marquent les esprits pour qu\'on oublie pas les conséquences de cette déclaration pour les femmes et la société' },
