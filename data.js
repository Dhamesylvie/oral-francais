const data = {
    ...
    },
    {
        ...
        questions: [
            ...
            { id: 'odg_postambule_q17', type: 'QCM', question: 'Pourquoi ODG utilise la <b>Métaphore</b> du Tocsin (cloche utilisée en temps de guerre) pour désigner la raison?', options: ["Avec cette idée de cloche de la raison ODG se place dans \'héritage des Lumières.", "Avec cette idée de cloche de la raison ODG se place dans l\'église."], answer: 0, explanation: 'Il s’agit ici de la cloche de la raison : ODG se place dans \'héritage des Lumières. La raison se répand partout et la femme doit en profiter pour faire valoir ses droits.' },
            ...
            { id: 'odg_postambule_q19', type: 'QCM', question: 'Quel est l\'objectif de la question rhétorique <b>"Que vous reste-t-il?</b>', options: ["Rappeler qu\'il faut toujours chercher", "Montrer l\'impuissance des femmes après la révolution."], answer: 1, explanation: 'Elle montre \'impuissance des femmes après la Révolution. Puis donne 2 réponses - 1re réponse : insiste sur l\'ingratitude des hommes - 2ème réponse : les femmes doivent réclamer encore se battre.' },
            ...
            { id: 'odg_postambule_q36', type: 'QCM_EXTRAIT', question: 'Dans cet extrait, quelles sont les 3 figures de style qui relancent l\'attention des femmes?', extract: "Ô femmes ! femmes, quand cesserez-vous d\'être aveugles ? ", options: ["Apostrophe + exclamation / Question rhétorique / Métaphore de l\'aveuglement", "Apostrophe + exclamation / Question rhétorique / Comparaison de l\'aveuglement"], answer: 0, explanation: 'Ces figures de style relancent \'attention des femmes. \'<b>exclamation</b> a un ton de déploration (lamentation). <br>La <b>question est purement rhétorique</b> : elle n’attend pas de réponse et vise simplement à faire réagir la femme. <br>La <b>métaphore</b> de \'aveuglement appelle à une prise de conscience. Les femmes ne doivent plus se soumettre.' },
            { id: 'odg_postambule_q37', type: 'QCM_EXTRAIT', question: 'Dans cet extrait, à quoi est comparé la métaphore de l\'aveuglement ?', extract: "Ô femmes ! femmes, <b>quand cesserez-vous d\'être aveugles</b> ? ", options: ["A l\'absence de prise de conscience des femmes", "A la loyauté des femmes"], answer: 0, explanation: 'La <b>métaphore</b> de \'aveuglement appelle à une <b>prise de conscience</b>. Les femmes ne doivent plus se soumettre.' },
            ...
            { id: 'odg_postambule_q43', type: 'QCM_EXTRAIT', question: 'Que valorise ODG avec l\'expression en gras dans cet extrait (et l\'adverbe intensif "si") ?', extract: 'Qu\'auriez-vous à redouter pour une <b>si belle entreprise</b> ?', options: ["La facilité de la lutte des femmes", "La noblesse et \'importance du combat des femmes", "La soumission des femmes à leur destin"], answer: 1, explanation: '\'adverbe intensif "si" valorise clairement le combat que mènent les femmes, insistant sur son importance et sa grandeur.' },
            { id: 'odg_postambule_q44', type: 'QCM_EXTRAIT', question: 'À quoi fait référence la <b>1ère crainte</b> des femmes qu\'évoque ODG dans la citation en gras ?', extract: '<b>Le bon mot du législateur des noces de Cana ?</b>', options: ["Une critique d’un discours à \'Assemblée Nationale", "Le regard ou jugement divin (épisode biblique des noces de Cana)", "Une crainte devant \'échec politique"], answer: 1, explanation: 'ODG explore la crainte des femmes <b>du regard de DIEU</b>. Avec la référence au législateur biblique des noces de Cana (Jésus), elle évoque symboliquement la crainte des femmes face au regard ou jugement divin.' },
            { id: 'odg_postambule_q45', type: 'QCM_EXTRAIT', question: 'À quoi fait référence la <b>2ème crainte</b> des femmes qu\'évoque ODG dans la citation en gras ?', extract: ' Craignez-vous que nos <b>législateurs français, correcteurs de cette morale</b> longtemps accrochée aux branches de la politique,', options: ["La réaction méprisante des Hommes", "Le regard ou jugement divin (épisode biblique des noces de Cana)", "Une crainte devant \'échec politique"], answer: 0, explanation: 'Les femmes auraient peur des hommes (“Législateurs français”) qui auraient pris le relais de Jésus (“Législateur des noces de Cana”) dans la correction de la morale. La morale religieuse et la politique ont longtemps été liées.' },
            { id: 'odg_postambule_q46', type: 'QCM_EXTRAIT', question: 'Dans cet extrait, comment ODG suggère-t-elle aux femmes de réagir face au rejet des hommes ?', extract: '" Femmes, qu’y a-t-il de commun entre vous et nous ? auriez-vous à répondre." " Tout ", auriez-vous à répondre.', options: ["Par la révolte violente", "Par \'indifférence", "Par une affirmation ferme d’une égalité totale"], answer: 2, explanation: 'Grâce au discours direct et à une réponse brève "Tout", ODG suggère une prise de position ferme et catégorique : les femmes doivent affirmer leur pleine égalité avec les hommes.' },
            ...
            { id:'odg_postambule_q65', type:'QCM', question:'Sur quoi insiste la négation restrictive "vous n\'avez qu\'à le vouloir"?', options:[ "Sur la difficulté extrême de la lutte des femmes.", "Sur le découragement face à \'inaction des législateurs.", "Sur le fait essentiel que seule la volonté des femmes est nécessaire à leur libération." ], answer: 2, explanation:'La négation restrictive ("ne...que...") met en avant l\'idée essentielle selon laquelle leur volonté seule suffit à leur libération.' },
    ...
    questions: [
        {
            ...
            answer: 1,
            explanation: '"Vénus Anadyomène" désigne littéralement Vénus sortant des eaux, en référence au mythe antique représentant Vénus née de \'écume marine.'
        },
        {
            id: 'venus_q2',
            type: 'VF',
        ...
        },
        {
            ...
            answer: 2,
            explanation: "<b>Elegance</b> (Les couleurs peuvent renvoyer au tableau de Botticelli). Bon marché ('fer' fait penser à une baignoire bon marché, rompt avec \'idéal)."
        },
        {
            id: 'venus_q6',
            type: 'QCM_EXTRAIT',
        ...
        },
       {
            ...
            extract: "<b>Puis</b> le col gras et gris, les larges omoplates <br> Qui saillent ; le dos court qui rentre et qui ressort ; <br> <b>Puis</b> les rondeurs des reins semblent prendre \'essor.",
            options: ["Assonance pour répeter des voyelles", "Une anaphore pour montrer la laideur de haut en bas."],
            answer: 1,
            explanation: "Description progressive du corps à travers l\'anaphore de \'adverbe 'puis' → le poète va montrer toute sa laideur au fur et à mesure que Vénus émerge de la baignoire. Hypotypose sordide : le présent donne \'impression qu’on voit Vénus sortir de \'eau."
        },
       {
            id: 'venus_q18',
            type: 'QCM_EXTRAIT',
            question: "Pourquoi le corps paraît-il difforme ?",
            extract: "Les <b>larges</b> omoplates <br> Qui <b>saillent</b> ; le dos <b>court</b> qui rentre et qui ressort ; <br> Puis les <b>rondeurs</b> des reins semblent prendre \'essor.",
            options: ["Utilisation d\'antithèses (termes opposés)", "Répétition de l\'adverbe 'puis'"],
            answer: 0,
            explanation: "antithèses : 'large' et 'court', omoplates qui  'saillent' (=maigreur mise en valeur par le rejet de la proposition subordonnée relative 'qui saillent') mais 'graisse' => le corps paraît difforme. Description à \'opposé des codes esthétiques traditionnels."
        },
        {
            id: 'venus_q19',
            type: 'QCM',
        ...
        },
        {
            ...
            answer: 1,
            explanation: "Le détail 'à la loupe' met en avant un aspect vulgaire et choquant, à savoir la relation avec 'Clara Vénus', une quasi-anagramme de 'ulcère à \'anus', soulignant une provocation scatologique."
        },
        {
            id: 'venus_q26',
            type: 'VF',
        ...
        },
        {
            ...
            answer: 1,
            explanation: "'Clara Vénus' (signifiant \"illustre Venus\") est presque une anagramme subtile de 'ulcère à \'anus', indiquant une chute volontaire dans le bas et le vulgaire."
        },
        {
            id: 'venus_q28',
            type: 'QCM',
    ...
    questions: [
        ...
        },
       {
        ...
        },
        {
            ...
            answer: 2,
            explanation: "Pour imager son propos, il évoque le moment où, à l\'aube de notre mort, nous faisons le bilan de notre vie, et pour lui, l\'existence ne saurait avoir de sens sans la passion, ce que prouve le rythme ternaire final et le passé composé, temps de l\'accompli, du bilan. <br> Ces propos sont directement inspirés d\'une lettre que George Sand a écrite à \'auteur."
        },
        {
            id: 'badine_q32',
            type: 'QCM_EXTRAIT',
