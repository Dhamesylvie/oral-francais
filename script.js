...
const textsData = [
    ...
    },
    {
        ...
        questions: [
            ...
            { id: 'odg_preambule_q19', type: 'QCM', question: 'Avec les expressions "bonnes moeurs" + "le bonheur de tous", que veut montrer ODG ?', options: ["Les bienfaits de la DDHC", "Que l'égalité Homme/femme sera bénéfique pour tous", "Que cette avancée sera uniquement bénéfique aux femmes."], answer: 1, explanation: ' l’égalité hommes/femmes sera bénéfique à toute la société, pas seulement aux femmes, d’où l’importance d’oeuvrer en sa faveur' }, // CORRIGÉ: index 2 -> 1
            { id: 'odg_preambule_q20', type: 'VF', question: 'Pour donner une dimension solennelle et de la sacralité (=ref à dieu) ODG utilise le présent et l\'expression "sous les auspices de l’Être suprême (=Dieu)"', answer: 'Vrai', explanation: ' Présent d’énonciation « reconnaît et déclare » + « sous les auspices de l’Être suprême (=Dieu) » : donne une solennité, sacralité à la déclaration.' }, // CORRIGÉ: typos "uilise", "expresiion" -> "utilise", "expression"
            { id: 'odg_preambule_q21', type: 'QCM', question: '"reconnaît et déclare" de quel temps s\'agit\'il?', options: ["Du présent d'énonciation", "Du présent de reconnexion", "Du présent de vérité générale"], answer: 0, explanation: 'Présent d’énonciation "reconnaît et déclare" + "sous les auspices de l’Être suprême (=Dieu)" : donne une solennité, sacralité à la déclaration.' }, // CORRIGÉ: typo "reconnection"
    ...
    },
    {
        ...
        questions: [
            ...
            // Ancien q30 (doublon de q27) supprimé
...
const endMessagesConfig = {
    mode1: {
        ...
        high: { title: "Bravo !", messages: [
                "Très bons résultats. Félicitations !", // CORRIGÉ: typo "résultats"
